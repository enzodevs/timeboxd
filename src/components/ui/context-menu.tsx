...
/**
 * Minimal shape shared by the dropdown- and context-menu item components, so a
 * component can render one set of menu items into either menu (see TodoItem,
 * Timebox). Both wrappers accept supersets of these props.
 */
